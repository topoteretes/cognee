...
async def main():
    ...
    parser.add_argument(
        ...
        "enabled). Sent as Authorization: Bearer by default, or as X-Api-Key for Cognee "
        "Cloud tenant URLs and when --api-auth-scheme=x-api-key. Can also be set via the "
        "COGNEE_API_KEY env var.",
    )
