...
T = TypeVar("T", bound="BodyAddApiV1AddPost")


@_attrs_define
class BodyAddApiV1AddPost:
    """
    Attributes:
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.dataset_name, Unset):
            if isinstance(self.dataset_name, str):
                files.append(("datasetName", (None, str(self.dataset_name).encode(), "text/plain")))
            else:
                files.append(("datasetName", (None, str(self.dataset_name).encode(), "text/plain")))

        if not isinstance(self.dataset_id, Unset):
            if isinstance(self.dataset_id, UUID):
                files.append(("datasetId", (None, str(self.dataset_id), "text/plain")))
            elif isinstance(self.dataset_id, str):
                files.append(("datasetId", (None, self.dataset_id, "text/plain")))
            else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        body_add_api_v1_add_post.additional_properties = d
        return body_add_api_v1_add_post
