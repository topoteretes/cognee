...
from ...models.settings_payload_dto import SettingsPayloadDTO
from ...types import Response


def _get_kwargs(
    *,
    body: SettingsPayloadDTO,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    - **vector_db** (Optional[VectorDBConfigInputDTO]): Vector database configuration (provider, URL,
    API key)
