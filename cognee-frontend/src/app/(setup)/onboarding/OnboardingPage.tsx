...
function skipToDashboard(router: ReturnType<typeof useRouter>, markOnboardingComplete: () => Promise<void>): void {
      ...
      {view === "company" && (
        podPending ? (
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "100vh", gap: 16 }}>
            ...
            <button
              onClick={() => skipToDashboard(router, markOnboardingComplete)}
