...
export default function DatasetDetailPage({ datasetId }: { datasetId: string }) {
  ...
  const { pendingWarning: pendingLowBalanceWarning, confirmUpload, continueAnyway: continueUploadAnyway, cancel: cancelLowBalanceUpload } = useLowBalanceUploadWarning();
  ...
  return (
    ...
    >
      ...
      <LowBalanceWarningModal
        ...
        onContinue={continueUploadAnyway}
