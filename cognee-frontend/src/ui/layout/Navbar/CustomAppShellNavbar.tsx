  ...
  return (
    <>
      ...
      >
        ...
        {/* Feedback, Book-a-call and Billing are cloud-only concepts: paid plans
            and credits do not exist self-hosted, and app/(app)/billing/ is excluded
            from the public sync, so the button would 404. Gating the whole footer
            here keeps it out of the synced public frontend. */}
        {isCloudEnvironment() && (
