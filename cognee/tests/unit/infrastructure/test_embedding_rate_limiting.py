...
from cognee.infrastructure.databases.vector.embeddings.OpenAIEmbeddingEngine import OpenAIEmbeddingEngine
...
async def test_embedding_rate_limiting():
    ...
    logger.info(f"Embedding Rate Limit: {config.embedding_rate_limit_requests} requests per {config.embedding_rate_limit_interval} seconds")
