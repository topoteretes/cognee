...
def test_sync_retry():
    ...
    try:
        ...
        assert test_function_sync.counter == 3, f"Expected 3 attempts, got {test_function_sync.counter}"
...
async def test_async_retry():
    ...
    try:
        ...
        # The function should succeed on the 3rd attempt (after 2 failures)
        assert test_function_async.counter == 3, f"Expected 3 attempts, got {test_function_async.counter}"
        assert elapsed >= 0.3, f"Expected at least 0.3 seconds of backoff, got {elapsed:.2f}"
