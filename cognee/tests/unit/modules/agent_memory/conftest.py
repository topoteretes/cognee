...
it. In a full-suite run the sibling ``modules/agents/conftest.py`` fixture
happened to run first (alphabetical order) and left the database behind;
the moment the suite is sharded across jobs, a shard without ``agents/``
