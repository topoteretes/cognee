...
async def test_extract_user_sessions_success(mock_user, mock_qa_data):
    ...
    with patch("cognee.tasks.memify.extract_user_sessions.session_user") as mock_session_user:
        ...
        with patch(
            "cognee.tasks.memify.extract_user_sessions.get_cache_engine",
            return_value=mock_cache_engine,
        ):
            sessions = []
