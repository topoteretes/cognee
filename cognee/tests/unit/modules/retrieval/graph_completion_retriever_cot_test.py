...
if __name__ == "__main__":
    ...
    test = TestGraphCompletionCoTRetriever()

    async def main():
        await test.test_graph_completion_cot_context_simple()
        await test.test_graph_completion_cot_context_complex()
        await test.test_get_graph_completion_cot_context_on_empty_graph()
