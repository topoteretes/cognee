...
async def main():
    bucket_name = os.getenv("AZURE_STORAGE_CONTAINER_NAME")
    test_run_id = uuid4()
    data_directory_path = f"az://{bucket_name}/{test_run_id}/data"
    cognee.config.data_root_directory(data_directory_path)
    cognee_directory_path = f"az://{bucket_name}/{test_run_id}/system"
