            ...
            async def _run_graph() -> list[RecallResponse]:
                ...
                if guard_active:
                    ...
                    if not probe.is_warm:
                        ...
                        elif probe.state == STATE_BUILD_IN_PROGRESS:
                            status = "build_in_progress"
                            text = (
                                "Memory is still building: an ingestion pipeline is "
                                "currently running for the requested datasets. Try again "
                                "shortly."
                            )
                        else:
