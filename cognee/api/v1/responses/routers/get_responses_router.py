...
def get_responses_router() -> APIRouter:
    ...
    async def create_response(
        ...
        - **maxCompletionTokens** (Optional[int]): Accepted for OpenAI API compatibility;
          not used when generating the response.
        - **user** (Optional[str]): Accepted for OpenAI API compatibility; not used when
