...
def get_agents_router() -> APIRouter:
    ...
    async def create_agent_endpoint(
        ...
        ## Query Parameters
        - **name** (str): Name for the new agent; a name already in use returns 409.
        """
        try:
    ...
    async def list_agents_connections(
        ...
        ## Query Parameters
        - **active_only** (bool): When true, limits results to connections currently
    ...
    async def register_agent_endpoint(
        ...
        - **dataset_names** (List[str]): Names of the datasets this agent connection is
          registered against.
