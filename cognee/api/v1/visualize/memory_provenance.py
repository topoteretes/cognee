...
async def _read_memory_relational(limit: int = 5000) -> Optional[MemoryPayload]:
...
async def get_memory_provenance_graph(
    ...
    # Built from SQLAlchemy ORM rows (whose attribute types are Column-typed),
    # then cast to the record TypedDicts at the build_provenance_graph call.
