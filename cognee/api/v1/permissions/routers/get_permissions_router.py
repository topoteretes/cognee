...
def get_permissions_router() -> APIRouter:
    ...
    async def give_default_permission_to_tenant(
        ...
        from cognee.modules.users.permissions.methods import give_default_permission_to_tenant as set_tenant_default_permissions
    ...
    async def give_default_permission_to_user(
        ...
        from cognee.modules.users.permissions.methods import give_default_permission_to_user as set_default_permission_to_user
