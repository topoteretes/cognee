...
async def extract_content_nodes_and_relationship_names(
    ...
    for round_num in range(n_rounds):
        ...
        text_input = render_prompt("extract_graph_relationship_names_prompt_input.txt", context)
        system_prompt = render_prompt("extract_graph_relationship_names_prompt_system.txt", context)
