...
class LayeredGraphBuilder:
    ...
    def add_subgraph_to_layer(
        self, layer_id: str, subgraph: KnowledgeGraph, id_prefix: str = ""
    ) -> Dict[str, str]:
        """
        ...
        for edge in subgraph.edges:
            ...
            # Keep track of edge
            self.layer_edges[layer_id].append(
                (new_source_id, new_target_id, edge.relationship_name)
            )
...
async def convert_to_layered_graph(
    ...
    layer_id = builder.create_layer(
        name=layer_name, description=layer_description, layer_type="base"
    )
