...
def load_alias_map(custom_path: Optional[str] = None) -> Dict[str, str]:
    """Load aliases from JSON. Keys must be in post-Step-3 form."""
...
def canonicalize_entity_name(name: str, alias_map: Optional[Dict[str, str]] = None) -> str:
    """
    Canonicalize an entity name to improve deterministic deduplication.
    ...
    # Steps 5: Collapse whitespace/hyphens/dots/underscores -> single space
