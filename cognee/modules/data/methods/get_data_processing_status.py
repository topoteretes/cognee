...
async def get_data_processing_status(data_id: UUID) -> FileProcessingStatus:
    """Retrieve the processing status of a data record."""
    ...
    async with db_engine.get_async_session() as session:
        ...
        return data_record.processing_status