...
class GraphCompletionCotRetriever(GraphCompletionRetriever):
    ...
    async def get_retrieved_objects(
        ...
        if session_save:
            ...
            if user_id:
                ...
                # The active session-context guidance block for the CoT rounds. Gated +
                # fail-open: never blocks CoT reasoning.
        ...
        _completion, context_text, triplets = await self._run_cot_completion(
            effective_batch, conversation_history, guidance, skip_final_completion=True
        )
    ...
    async def _run_cot_completion(
        ...
        -----------
            ...
            - guidance: Optional session guidance block
        ...
        await self._generate_completions(states, conversation_history, guidance)
    ...
    async def _generate_completions(self, states: dict, conversation_history: str, guidance: str):
