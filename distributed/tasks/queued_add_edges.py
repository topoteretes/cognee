...
async def queued_add_edges(
    ...
    try:
        await add_nodes_and_edges_queue.put.aio(([], edge_batch, source_ref_key, pipeline_run_id))
        ...
        await queued_add_edges(first_half, source_ref_key, pipeline_run_id)
        await queued_add_edges(second_half, source_ref_key, pipeline_run_id)
