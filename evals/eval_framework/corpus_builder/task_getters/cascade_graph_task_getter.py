...
from cognee.tasks.graph.extract_graph_from_code_v2 import (
...
class CascadeGraphTaskGetter(BaseTaskGetter):
    """Task getter that implements a cascading graph extraction approach."""

    async def get_tasks(
        self, user: User = None, graph_model: BaseModel = KnowledgeGraph
    ) -> List[Task]:
