...
RUN --mount=type=cache,target=/root/.cache/uv \
    ...
    uv sync "$@" --extra codegraph --extra debug --extra api --extra postgres --extra neo4j --extra llama-index --extra aws --extra dlt --extra ollama --extra mistral --extra groq --extra anthropic --frozen --no-install-project --no-dev --no-editable
...
RUN --mount=type=cache,target=/root/.cache/uv \
    ...
    uv sync "$@" --extra codegraph --extra debug --extra aws --extra api --extra postgres --extra neo4j --extra llama-index --extra dlt --extra ollama --extra mistral --extra groq --extra anthropic --frozen --no-dev --no-editable
