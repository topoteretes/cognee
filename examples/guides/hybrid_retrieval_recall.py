...
(chunks_top_k, entities_top_k, max_edges_per_entity, facts_top_k) so the printed contexts show what
each source contributes, then answered once with the balanced mix.
